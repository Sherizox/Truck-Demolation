...
public class MoneyCounterAdd : MonoBehaviour {
    ...
    private void OnEnable()
    {
        ...
        if (isFail)
            reward = reward - 800;
		PrefsManager.SetCoinsValue(PrefsManager.GetCoinsValue() + reward + (LevelManager.instace.LevelCoin));



		addCointList.Clear();
   //     addCointList.Add(LevelManager.instace.coinsCounter);
       addCointList.Add(LevelManager.instace.LevelCoin);
  ...
  //  private int numIteration=3;
    public  IEnumerator AddCoins(){
      ...
      //  rewradMoneyText[0].text = LevelManager.instace.coinsCounter + "";
        rewradMoneyText[0].text = LevelManager.instace.LevelCoin + "";
        rewradMoneyText[2].text = PrefsManager.GetCoinsValue() + "";
        rewradMoneyText[1].text = reward + "";
       addCointList.Clear();
        Time.timeScale = 0;
    ...
    public void DoubleReward()
    {
        ...
        rewradMoneyText[2].text = PrefsManager.GetCoinsValue() + "";
        rewradMoneyText[1].text = reward * 2 + "";
        rewradMoneyText[0].text =LevelManager.instace.LevelCoin + "";
