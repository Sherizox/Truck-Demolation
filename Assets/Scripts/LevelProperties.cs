...
public class LevelProperties : MonoBehaviour
{
    ...
    public float Time;
    public int currentobjective = 0, TotalEnemy = 0;
    ...
    public void Nextobjective()
    {
        ...
        {
            if (freemode && LevelManager.instace.SelectedPlayer.GetComponent<VehicleProperties>())
            {
                ...
                //LevelManager.instace.mapPath.Target = gameObjectDrop.transform.GetChild(0).GetChild(0);
            ...
            //LevelManager.instace.mapPath.SetDestinationAtFirst(LevelObjective[currentobjective].transform.GetChild(0).GetChild(0));
