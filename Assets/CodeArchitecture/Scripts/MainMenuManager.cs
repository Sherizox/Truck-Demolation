    ...
    public void ModeSelected(int modselect)
    {
      //  SoundManager.Instance.PlayOneShotSounds(SoundManager.Instance.click);
        ...
        if (modselect == 1)
        {
            ...
            DogSelectionManager.instance.dogSelectionCanvas.SetActive(true);
            DogSelectionManager.instance.menuCanvas.SetActive(false);
            DogSelectionManager.instance.SelectDogPlay();
        }
        else { 
        DogSelectionManager.instance.RedirectToDogSelection();
